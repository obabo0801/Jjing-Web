...
- 설정 메뉴 기능 추가
- 알림, 데이터, 사운드, 언어, 테마 설정 지원
- Push 알림 켜기 및 끄기 기능 추가
- 알림 및 마이크 권한 안내 기능 추가
- 쿠키 및 저장 데이터 사용량 확인과 삭제 기능 추가
- 효과음 및 진동 설정 기능 추가
- 전체, 미디어, 알림, 음성, 시스템 음량 조절 지원
- 화면 밝기 조절 기능 추가
- 검색창 및 음성 입력 기능 추가
- 체크박스, 라디오, 스위치, 슬라이더 등 공통 화면 요소 추가
- 진행 표시 및 로딩 화면 기능 추가
- 인터넷 연결 실패와 서버 오류 화면 구분 개선
