...
const wearable = matchMedia("(width <= 480px) and (height <= 480px)");

const small = matchMedia("(width <= 32rem) and (height <= 24rem)");

const short = matchMedia("(orientation: landscape) and " + "(height <= 32rem)");
const state = {};
